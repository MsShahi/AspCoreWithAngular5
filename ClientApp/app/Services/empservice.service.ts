...
export class EmployeeService {
    ...
    saveEmployee(employee) {
        return this._http.get(this.myAppUrl + 'api/Employee/Create' + employee)
            .map((response: Response) => response.json())
            .catch(this.errorHandler);
    }
    updateEmployeee(employee) {
        return this._http.get(this.myAppUrl + 'api/Employee/Edit' + employee)
            .map((response: Response) => response.json())
            .catch(this.errorHandler);
    }
    deleteEmployee(id) {
